// --- START OF FILE ApiEndpointsTests.cs (FINAL, FOR REAL THIS TIME) ---
...
public class ApiEndpointsTests : IClassFixture<CustomWebApplicationFactory>
{
    ...
    // The fix is to make the constructor explicitly 'public'
    ...
    public async Task Post_ScanEndpoints_ShouldReturnAccepted(string endpoint)
    {
        ...
        _scanManagerMock.Setup(s => s.ScanZombiesForDNameAsync(It.IsAny<string>(), It.IsAny<string>())).ReturnsAsync(true);
